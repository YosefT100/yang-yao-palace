            ...
            {(courses as Course[] | null)?.map((course) => {
              ...
              return (
                <div key={course.id} className="card flex flex-col" style={{ borderTop: "3px solid #D4AF37" }}>
                  ...
                  <a
                    href={`https://api.whatsapp.com/send?phone=972528847770&text=${encodeURIComponent(`Hi! I'm interested in the ${course.name} course at Yang Yao Palace. Could you please send me more information about pricing and enrollment?`)}`}
                    target="_blank"
      ...
      <section className="bg-white py-24" style={{ borderTop: "1px solid rgba(212,175,55,0.15)" }}>
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
            {[
              { labelKey: "beginner" as const, range: "HSK 1-2", level: "Beginner (HSK 1-2)" },
              { labelKey: "intermediate" as const, range: "HSK 3-4", level: "Intermediate (HSK 3-4)" },
              { labelKey: "advanced" as const, range: "HSK 5-6", level: "Advanced (HSK 5-6)" },
            ].map(({ labelKey, range, level }) => (
              <div key={level} className="card flex flex-col" style={{ borderTop: "3px solid #D4AF37" }}>
                ...
                <a
                  href={`https://api.whatsapp.com/send?phone=972528847770&text=${encodeURIComponent(`Hi! I'm interested in the ${level} 1-on-1 Private Lessons at Yang Yao Palace. Could you please send me more information about pricing and enrollment?`)}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 rounded-lg py-2 px-4 text-sm font-semibold text-white transition-opacity hover:opacity-90"
                  style={{ backgroundColor: "#25D366" }}
